...
def body_code():
    ...
    if r[1] >= 0:  # User is successfully verified.
        ...
        # Verification failed.
        if r[1] == -1:
            tkMessageBox.showwarning('Failed', "Time Out... !")     #Error message for sensor timeout.
        elif r[1] == -3:
            tkMessageBox.showwarning('Failed', "No User Found... !")#Error message for not registered user.
        elif r[1] == -2:
            tkMessageBox.showerror("Failed:", "Please try to place the center of the fingerprint flat to sensor !")#Error message for wrong orientation. 
