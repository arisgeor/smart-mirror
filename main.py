...
con=sql.connect('\home\pi\smart-mirror\finger_users.db')
cur=con.cursor()
...
def menu_bar(window_name):
    ...
    window_menu.add_command(label="For Minimized Press Esc key", command=lambda: tkMessageBox.showinfo())
    window_menu.add_separator()
